...
{
  SettingsPort << F("Batterie type: ");
  switch (batteryType)
  {
    case BATTERY_TYPE_NONE:SettingsPort << F("no battery : ");break;
    case BATTERY_TYPE_NIMH:SettingsPort << F("NIMH : ");break;
    case BATTERY_TYPE_LIPO:SettingsPort << F("LIPO : ");break;
  }
  SettingsPort << _FLOAT(GetExternalVoltage(),3) << F("v (")<< battery_numberOfCells() << F(" elements)") << endl;
}
#endif
