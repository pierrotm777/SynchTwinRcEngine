...
#Region "Settings"
    ...
    Private Sub btnSend_Click(sender As System.Object, e As System.EventArgs) Handles btnSend.Click
        If SerialPort1.IsOpen() Then
            SerialPort1.Write(Trim(Str(txtMessage.Text)) & vbCr)
...
#Region "Simulation"
    ...
    Private Sub ButtonRecorder_Click(sender As System.Object, e As System.EventArgs) Handles ButtonRecorder.Click
        ...
        If RecorderIsOn = True Then
            ...
            svfd.InitialDirectory = RecordFilesPath
            svfd.Title = "Save a Record File"
            'svfd.RestoreDirectory = True
            svfd.ShowDialog()

            If svfd.FileName = "" Then
                If My.Settings.Language = "French" Then
                    MsgBox("Vous n'avez entré aucun nom...L'opération d'enregistrement ne peut pas continuer !")
                ElseIf My.Settings.Language = "English" Then
                    MsgBox("You didn't enter Any File Name...So Rercord Operation Cannot Continue !")
                End If
                RecorderIsOn = False
                Exit Sub
            Else
    ...
    Private Sub ButtonPlayer_Click(sender As System.Object, e As System.EventArgs) Handles ButtonPlayer.Click
        ...
        If PlayerIsOn = True Then
            ...
            fd.InitialDirectory = RecordFilesPath
...
#Region "SD Card"
    ...
    Private Sub ButtonSDCardListFiles_Click(sender As System.Object, e As System.EventArgs) Handles ButtonSDCardListFiles.Click
        ...
        If term.Visible = True Then
            term.TextBoxTerminalComPort.AppendText("373" & vbCrLf)
        End If
    End Sub
...
#Region "TabPages"
    ...
    Private Sub ButtonSettings_Click(sender As System.Object, e As System.EventArgs) Handles TabPage2.Enter
        ...
        Try
            SerialPort1.Write("363" & vbCr) 'recupération de la configuration du module
            Thread.Sleep(500)
...
#End Region
    ...
    Private Sub BackgroundWorkerThrottle_DoWork(sender As Object, e As DoWorkEventArgs) Handles BackgroundWorkerThrottle.DoWork
    ...
    Private Sub BackgroundWorkerThrottle_RunWorkerCompleted(sender As Object, e As RunWorkerCompletedEventArgs) Handles BackgroundWorkerThrottle.RunWorkerCompleted
        'ButtonPlayer.Text = "Start Player"
        'PictureBoxPlayer.Image = My.Resources.rectangle_rouge
    End Sub

    Private Sub BackgroundWorkerAuxiliary_DoWork(sender As System.Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorkerAuxiliary.DoWork
    ...
    Private Sub BackgroundWorkerAuxiliary_RunWorkerCompleted(sender As Object, e As RunWorkerCompletedEventArgs) Handles BackgroundWorkerAuxiliary.RunWorkerCompleted
        'ButtonPlayer.Text = "Start Player"
        'PictureBoxPlayer.Image = My.Resources.rectangle_rouge
    End Sub
